...
@Component({
      ...
      @if (auth.isLoggedIn) {
        <nav class="sidebar">
          ...
          <div class="nav-section">
            ...
            <a routerLink="/vmt-uam/dashboard" routerLinkActive="active" class="nav-item">
              <span class="ni">📈</span> VMT-UAM Dashboard
            </a>
            <a routerLink="/vmt-uam/entry" routerLinkActive="active" class="nav-item">
              <span class="ni">📄</span> Data Entry
            </a>
            <a routerLink="/vmt-uam/report" routerLinkActive="active" class="nav-item">
              <span class="ni">📝</span> Weekly Report
            </a>
            <a routerLink="/vmt-uam/history" routerLinkActive="active" class="nav-item">
              <span class="ni">🕐</span> Report History
            </a>
  ...
  styles: [`
    ...
    .nav-label { font-size:10px; font-weight:700; color:rgba(255,255,255,.35); letter-spacing:1.2px; padding:0 16px 8px; text-transform:uppercase }
    ...
    .nav-item.active { background:rgba(220,38,38,.12); color:#fff; border-left-color:#dc2626 }
    .ni { font-size:15px }
    ...
    .has-nav .main-content { margin-left:220px }
  `]
})
